...
const s2 = await agent(
  ...
  `  - Add a "Starters" gallery (in the menu/composer, or a panel): read res://data/presets/starters/index.json -> list the starters (name + caption + dynamics + a gen-1/checkpoint badge). Pick one -> LOAD it:\n` +
